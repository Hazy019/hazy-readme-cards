...
<g clip-path="url(#hc)">
  ...
  <text x="76" y="21" font-family="Consolas, 'Courier New', monospace" font-size="11" fill="${c.dim}">~/kyrell-santillan — zsh</text>
  ...
  <text x="32" y="96" font-family="Consolas, 'Courier New', monospace" font-size="11" letter-spacing="0.5" fill="${c.muted}">
    Web Designer  ·  <tspan fill="${c.accent}">Frontend Engineer</tspan>  ·  Cybersecurity  ·  Philippines  ·  UTC+8
  </text>

  <!-- Open for work badge -->
  <rect x="32" y="104" width="118" height="18" rx="9" fill="${c.aBg}" stroke="${c.border}" stroke-width="0.5"/>
