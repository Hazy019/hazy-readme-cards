...
* **Edge-Optimized Performance:** Built on the **Next.js Edge Runtime** for global low-latency responses.
* **Fluid Animations:** Smooth visual transitions powered by **Framer Motion**.
...
#### **Backend & Automation**
* **Languages:** Python (Flask, FastAPI), Node.js
* **Automation:** AI-driven video production pipelines, Custom API Integration
* **Database:** PostgreSQL
